export default {
  ...
  settings: {
    ...
    processorPluginHint: 'Built-in truck and example plugins are provided. You can also type a custom plugin name already registered in the backend. Changes take effect after stopping and starting analysis services again.',
    processorPluginTruck: 'truck (truck arrival scenario)',
    processorPluginExample: 'example (generic sample scenario)',
    ...
    viewTodayVehicleEvents: "View Today's Vehicle Events",
    todayVehicleEvents: "Today's Vehicle Events",
    vehicleEventSource: 'Source',
    vehicleEventPlate: 'Plate',
    vehicleEventEnterTime: 'Arrival Time',
    vehicleEventExitTime: 'Exit Time',
    vehicleEventMissingActions: 'Missing Actions',
    vehicleEventsLoadFailed: 'Failed to load vehicle events: {message}',
