export default {
  ...
  settings: {
    ...
    viewTodayVehicleEvents: '查看当天车辆事件',
    todayVehicleEvents: '当天车辆事件',
    vehicleEventSource: '视频源',
    vehicleEventPlate: '车牌',
    vehicleEventEnterTime: '到达时间',
    vehicleEventExitTime: '离开时间',
    vehicleEventMissingActions: '缺失动作',
    vehicleEventsLoadFailed: '加载当天车辆事件失败：{message}',
